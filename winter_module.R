...
Nbees=seq(from = 0, to = 50000, by = 5000)
...
legend(0, 50000, legend=c("At 2oC", "At 15oC"),col=c("green", "red"),lty=1:1, cex=0.8,box.lty=0)
dev.off
...
legend(0, 70, legend=c("At 2oC", "At 15oC"),col=c("green", "red"),lty=1:1, cex=0.8,box.lty=0)
dev.off
...
legend(0, 225, legend=c("At 2oC", "At 15oC"),col=c("green", "red"),lty=1:1, cex=0.8,box.lty=0)
dev.off
